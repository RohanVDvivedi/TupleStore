...
int main()
{
	...
	tuple_type_info->containees[2].type_info = FLOAT_double_NULLABLE;
	...
	set_user_value_to_containee_in_container(tuple_type_info, tuple, 2, 0, (user_value){.double_value = -5});
	...
	set_user_value_to_containee_in_container(tuple_type_info, tuple, 2, 0, (user_value){.double_value = 55});
