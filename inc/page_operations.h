...
// Upage => uncompressed page
// Cpage => compressed page
...
int read_next_tuple(void** tuple, const void* Upage, unsigned int tuple_length, cell_definition def[]);
...
int write_next_tuple(void** tuple, void* Upage, unsigned int tuple_length, cell_definition def[]);
